...
abstract class MySwipeHelper(context: Context, private val recyclerView: RecyclerView, private var buttonWidth: Int): ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT) {
    ...
    private val onTouchListner = View.OnTouchListener { _, motionEvent ->
    ...
    inner class MyButton(private val context: Context, private val text: String,
                         private val textSize:Int, private val imageResId:Int,
                         private val color:Int, private val listner:IMyButtonCallback)
    {
        ...
        fun onDraw(c:Canvas, rectf: RectF, pos:Int){
            ...
            var x= 0f
            var y= 0f
            if (imageResId == 0)   //Just Text background
            {
    ...
    override fun onChildDraw(
        ...
        super.onChildDraw(c, recyclerView, viewHolder, /*dX is used when u want to remove the whole layout from display and translationX id used when u want a sticky layout */translationX, dY, actionState, isCurrentlyActive)
    }
