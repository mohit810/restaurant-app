...
class ExpandableAdapter(
    ...
    private val expandableListDetail: LinkedHashMap<String, MutableList<String>>
    ...
    override fun getChildView(
        ...
        val expandedListTextView = convertView
            ?.findViewById<View>(R.id.child_txt) as TextView
    ...
    override fun getGroupView(
        ...
        val listTitleTextView = convertView
            ?.findViewById<View>(R.id.parent_txt) as TextView
